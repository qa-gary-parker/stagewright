...
const tiers = [
  {
    ...
    comingSoon: false,
    features: [
      'Single-file HTML report \u2014 share with anyone, no server needed',
      ...
      'Trend charts that reveal long-term quality drift',
  ...
  },
  {
    ...
    features: [
      ...
      '5,000 AI-powered root cause analyses per month',
      'Fully custom theme colours to match your brand',
      'Choose from 3 PDF report styles before exporting',
