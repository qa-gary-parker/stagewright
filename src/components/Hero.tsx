    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden px-6 noise-overlay">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto">
        ...
        >
          <a
            href="#signup"
            className="btn-glow px-8 py-4 bg-green-600 hover:bg-green-500 text-white text-lg font-semibold rounded-xl shadow-lg shadow-green-500/25 hover:shadow-green-500/40 transform hover:scale-[1.02] transition-all duration-200"
          >
            Join the Waitlist
          </a>
          <a
